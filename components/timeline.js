...
//             <div className="flex min-h-screen flex-col items-center justify-between pt-16 space-x-4">
//                 <div>
//                     <h2 className="text-4xl font-bold text-center">Story Line</h2>
//                     <p className="text-center">Our journey from Delhi to Hyderabad</p>
//                 </div>
...
export default function TimeLine() {
    return (
        <div className="my-12 py-8 flex flex-row w-full border-y-2 border-black dark:border-neutral-800">
            <div className="w-1/2 flex flex-col items-center justify-between pt-12 space-x-4">
                <div>
                    <h2 className="text-4xl font-bold text-center mb-5">About Us</h2>
                    {/* Add your About Us content here */}
                    <p className=" px-20">Aman Mithaiwala Pvt. Ltd. is a family-owned business dedicated to preserving the rich heritage of traditional Indian sweets. Established in [Year], we craft authentic and delectable sweets using time-honored recipes and techniques.
            ...
            <div className="w-px bg-black mx-2"></div> {/* This is the vertical bar */}
            <div className="w-1/2 flex flex-col items-center justify-between pt-12 space-x-4">
                <div>
                    <h2 className="text-4xl font-bold text-center mb-5">Story Line</h2>
                </div>
                <div className="z-10 items-center justify-between font-mono text-sm lg:flex">
