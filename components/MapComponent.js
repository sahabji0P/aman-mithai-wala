...
import map from '../public/reach.jpeg';
        ...
        <div>
            <div className={styles.container}>
                ...
                <div className={`${styles.smallContainer} ${styles.two}`}>
                    <div className={styles.popup}>
                        <h1>Delhi</h1>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore ipsa sed necessitatibus? Nulla, corporis cupiditate, explicabo rerum nemo accusantium nihil eveniet, eaque id dolor aut? Quod numquam est consectetur temporibus.</p>
                        <div style={{ maxWidth: '100%', overflow: 'hidden', width: '500px', height: '300px' }}>
